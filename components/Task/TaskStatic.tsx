...
const TaskStatic = ({ todo }: { todo: Todo }) => {
  ...
  return (
    ...
    >
      <article className='z-1 bg-task shadow hover:shadow-md hover:bg-darktask flex flex-row justify-between rounded-lg py-5 pl-0 pr-3'>
        <div className='flex flex-row items-center space-x-2'>
          <div className='cursor-context-menu pt-4 pl-4 pb-4'>
