            ...
            <div className="flex flex-col space-y-2 pt-4">
              <div className="flex flex-col items-center sm:flex-row space-x-0 space-y-3 sm:space-y-0 sm:space-x-3">
                <button
                  type="submit"
                  disabled={loading}
                  className="bg-adamYellow w-full opacity-90 hover:opacity-100 shadow-sm hover:shadow-lg dark:hover:ring-1 ring-high-contrast transition-all text-white font-semibold outline-0 outline-black rounded-md px-4 py-3"
                >
                  Sign In
                </button>
              </div>
